...
<style>
  ...
  .register-body .top-content {
    margin-bottom: 20px;
    text-align: center;
  }
  .register-body .code-part .right-btn {
    color: #fff;
    border-radius: 0;
    border-color: #3a8ee6;
    background-color: #3a8ee6;
  }
  .register-body .code-part .right-btn[disabled] {
    padding-left: 6px;
    padding-right: 6px;
    color: #bbb;
    border-radius: 0;
  ...
  .register-body .code-part .el-input-group__append {
    border-color: #3a8ee6;
  }
  .register-body .code-part .disable-active .el-input-group__append {
    border-color: #dcdfe6;
  }
  .extra-text {
    margin-bottom: 0;
  }
  .extra-text .service-text {
    font-size: 1rem;
    color: #4e69f4;
  }
  .extra-text .service-text:hover {
    color: #4e69f4;
  }
  .extra-text p {
    text-align: right;
